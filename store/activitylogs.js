...
export const actions = {
    async getDataList ({ state, commit }, payload) {
        ...
        try {
            ...
            const data = await this.$axios.$get(`/api/admin/activity-logs`, {params: tableParams})
    ...
    create ({ commit }, data) {
        ...
        return this.$axios.$post('/api/admin/activity-logs', data)
    ...
    update ({ commit }, data) {
        ...
        return this.$axios.$put(`/api/admin/activity-logs/${data.id}`, data)
          .then(function (response) {
