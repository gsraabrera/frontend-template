...
export const actions = {
    async getDataList ({ state, commit }, payload) {
        ...
        try {
            ...
            const data = await this.$axios.$get(`/api/admin/persons`, {params: tableParams})
    ...
    create ({ commit }, data) {
        ...
        return this.$axios.$post('/api/admin/persons', data)
    ...
    update ({ commit }, data) {
        ...
        return this.$axios.$put(`/api/admin/persons/${data.id}`, data)
          .then(function (response) {
